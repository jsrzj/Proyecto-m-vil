...
@Composable
fun Home(navController: NavController, viewModel: RestaurantesViewModel) {
    val restaurantes: List<Restaurante> by viewModel.restaurantes.observeAsState(emptyList())
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = { /* do something */ }) {
                        Icon(
                            painterResource(id = R.drawable.notify_icon),
